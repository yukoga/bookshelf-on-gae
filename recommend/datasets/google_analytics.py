...
class GoogleAnalytics(AbstractDataset):
    '''
    Retrieve data from Google Analytics Core Reporting API, then build and return its pandas.DataFrame.
    '''
    ...
    def __init__(self, params=None):
        ...
        credentials = ServiceAccountCredentials.from_p12_keyfile(self.service_account_email, self.key_file, scopes=self.scope)
